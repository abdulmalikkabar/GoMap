...
public class ActivityAtm extends AppCompatActivity implements LocationListener, SwipeRefreshLayout.OnRefreshListener,
...
///Map
    ...
    private static final String url = "https://gomaps.000webhostapp.com/json/j_atm.php?lat=";
    private String url2 = "https://gomaps.000webhostapp.com/json/marker.php";
    public static final String url_cari = "https://gomaps.000webhostapp.com/json/cari_atm.php?lat=-6.894796&lng=110.638413";
    ...
    public static final String TAG_PECAHAN= "pecahan";
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        ...
        adapter = new Adapter_Atm(this,itemList);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                m.setPecahan(obj.getString("pecahan"));
    ...
    private void cariData(final String keyword) {
        pDialog = new ProgressDialog(ActivityAtm.this);
                ...
                try {
                    ...
                    if (value == 1) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            data.setPecahan(obj.getString(TAG_PECAHAN));
    ...
    private void getMarkers() {
        StringRequest strReq = new StringRequest(Request.Method.POST, url2, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ActivityAtm.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
